...
const ResourceName = "dynatrace_azure_credentials"
const TestDataFolder = "../../test_data/credentials/azure"
const RequestPath = "%s/azure/credentials/%s"
const TestCaseID = "azure_credentials"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := azure.NewService(providerConf.DTenvURL, providerConf.APIToken)
