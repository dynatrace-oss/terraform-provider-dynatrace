...
var ResourceTypes = struct {
	...
	OpenpipelineAzureLogsForwardingIngestsources ResourceType
	OpenpipelineAzureLogsForwardingPipelines     ResourceType
	OpenpipelineAzureLogsForwardingRouting       ResourceType
	...
	"dynatrace_openpipeline_v2_azure_logs_forwarding_ingestsources",
	"dynatrace_openpipeline_v2_azure_logs_forwarding_pipelines",
	"dynatrace_openpipeline_v2_azure_logs_forwarding_routing",
