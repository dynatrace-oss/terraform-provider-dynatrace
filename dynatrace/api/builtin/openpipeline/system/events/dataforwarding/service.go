...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/system/events/dataforwarding/settings"
...
const SchemaID = "builtin:openpipeline.system.events.data-forwarding"
