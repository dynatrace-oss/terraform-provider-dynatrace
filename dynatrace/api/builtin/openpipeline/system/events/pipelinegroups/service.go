...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/system/events/pipelinegroups/settings"
...
const SchemaID = "builtin:openpipeline.system.events.pipeline-groups"
