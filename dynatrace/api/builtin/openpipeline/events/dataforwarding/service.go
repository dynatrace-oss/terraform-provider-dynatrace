...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/events/dataforwarding/settings"
...
const SchemaID = "builtin:openpipeline.events.data-forwarding"
