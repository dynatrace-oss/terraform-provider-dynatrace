...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/events/sdlc/pipelinegroups/settings"
...
const SchemaID = "builtin:openpipeline.events.sdlc.pipeline-groups"
