...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/events/sdlc/dataforwarding/settings"
...
const SchemaID = "builtin:openpipeline.events.sdlc.data-forwarding"
