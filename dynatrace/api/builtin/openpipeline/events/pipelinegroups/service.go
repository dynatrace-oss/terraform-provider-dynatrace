...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/events/pipelinegroups/settings"
...
const SchemaID = "builtin:openpipeline.events.pipeline-groups"
