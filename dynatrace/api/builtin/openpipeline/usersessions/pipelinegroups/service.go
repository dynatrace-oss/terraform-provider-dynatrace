...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/usersessions/pipelinegroups/settings"
...
const SchemaID = "builtin:openpipeline.usersessions.pipeline-groups"
