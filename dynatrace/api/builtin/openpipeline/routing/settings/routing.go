...
func (re *RoutingEntry) MarshalHCL(properties hcl.Properties) error {
	...
	if re.PipelineID != nil {
		if err := properties.Encode("pipeline_id", re.PipelineID); err != nil {
			return err
		}
	}
	if re.BuiltinPipelineID != nil {
		if err := properties.Encode("builtin_pipeline_id", re.BuiltinPipelineID); err != nil {
			return err
		}
	}
