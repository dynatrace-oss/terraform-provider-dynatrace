...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/metrics/pipelinegroups/settings"
...
const SchemaID = "builtin:openpipeline.metrics.pipeline-groups"
