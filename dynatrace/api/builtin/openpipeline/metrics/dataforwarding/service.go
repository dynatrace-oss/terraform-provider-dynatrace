...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/metrics/dataforwarding/settings"
...
const SchemaID = "builtin:openpipeline.metrics.data-forwarding"
