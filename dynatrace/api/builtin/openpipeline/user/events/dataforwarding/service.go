...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/user/events/dataforwarding/settings"
...
const SchemaID = "builtin:openpipeline.user.events.data-forwarding"
