...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/user/events/pipelinegroups/settings"
...
const SchemaID = "builtin:openpipeline.user.events.pipeline-groups"
