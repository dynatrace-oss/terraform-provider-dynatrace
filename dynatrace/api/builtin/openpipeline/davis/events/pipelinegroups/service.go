...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/davis/events/pipelinegroups/settings"
...
const SchemaID = "builtin:openpipeline.davis.events.pipeline-groups"
