...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/davis/problems/pipelinegroups/settings"
...
const SchemaID = "builtin:openpipeline.davis.problems.pipeline-groups"
