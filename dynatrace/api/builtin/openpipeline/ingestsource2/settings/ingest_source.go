...
import (
	...
	"github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/ingestsource2/settings/processors"
...
func (ep *Processing) MarshalHCL(properties hcl.Properties) error {
	return properties.EncodeSlice("processor", ep.Processors)
}

func (ep *Processing) UnmarshalHCL(decoder hcl.Decoder) error {
	return decoder.DecodeSlice("processor", &ep.Processors)
}

func (ep Processing) MarshalJSON() ([]byte, error) {
...
func (ep *Processing) UnmarshalJSON(b []byte) error {
	rawProcessors := []json.RawMessage{}
