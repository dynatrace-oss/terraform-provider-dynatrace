...
package ingestsources_test

import (
	"testing"

	ingestsources "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/security/events/ingestsources/settings"
...
func TestOpenPipelineSecurityEventsIngestSourcesUnmarshal(t *testing.T) {
	...
	validWithEmpty := ingestsources.FieldExtractionEntries{{ExtractionType: "field", SourceFieldName: new("")}, {}}
