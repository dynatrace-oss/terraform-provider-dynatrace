resource "dynatrace_openpipeline_v2_security_events_dataforwarding" "example" {
  ...
  ingest_sources       = [dynatrace_openpipeline_v2_security_events_ingestsources.source.id]
...
resource "dynatrace_openpipeline_v2_security_events_ingestsources" "source" {
