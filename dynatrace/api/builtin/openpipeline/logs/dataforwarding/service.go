...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/logs/dataforwarding/settings"
...
const SchemaID = "builtin:openpipeline.logs.data-forwarding"
