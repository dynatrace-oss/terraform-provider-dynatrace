...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/spans/pipelinegroups/settings"
...
const SchemaID = "builtin:openpipeline.spans.pipeline-groups"
