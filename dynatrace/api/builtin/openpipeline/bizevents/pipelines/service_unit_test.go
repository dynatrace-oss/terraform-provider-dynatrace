...
import (
	...
	pipelines "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/bizevents/pipelines/settings"
...
func TestOpenPipelineBizeventsPipelinesUnmarshal(t *testing.T) {
	...
	validWithEmpty := pipelines.FieldExtractionEntries{{ExtractionType: "field"}}
