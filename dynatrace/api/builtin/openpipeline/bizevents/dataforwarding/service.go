...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/openpipeline/bizevents/dataforwarding/settings"
...
const SchemaID = "builtin:openpipeline.bizevents.data-forwarding"
