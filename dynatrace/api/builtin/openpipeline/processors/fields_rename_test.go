...
func TestFieldsRenameAttributes_MarshalHCL(t *testing.T) {
	var input = FieldsRenameAttributes{
...
func TestFieldsRenameAttributes_UnmarshalHCL(t *testing.T) {
	...
	var expected = FieldsRenameAttributes{
		Fields: []*FieldsRenameItem{
			{
				FromName: "some-name",
				ToName:   "new-name",
	...
	d := schema.TestResourceDataRaw(t, new(FieldsRenameAttributes).Schema(), input)
	assert.NotNil(t, d)

	var actual FieldsRenameAttributes
...
func TestFieldsRenameAttributes_Validate(t *testing.T) {
	...
	r := &schema.Resource{Schema: new(FieldsRenameAttributes).Schema()}
