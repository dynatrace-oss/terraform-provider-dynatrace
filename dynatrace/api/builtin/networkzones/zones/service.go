...
import (
	service "github.com/dynatrace-oss/terraform-provider-dynatrace/dynatrace/api/builtin/networkzones/zones/settings"
...
const SchemaID = "builtin:networkzones.zones"
