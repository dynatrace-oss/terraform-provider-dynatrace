...
func (me *OOMKillsConfig) Schema() map[string]*schema.Schema {
...
func (me *OOMKillsConfig) MarshalHCL(properties hcl.Properties) error {
...
func (me *OOMKillsConfig) UnmarshalHCL(decoder hcl.Decoder) error {
