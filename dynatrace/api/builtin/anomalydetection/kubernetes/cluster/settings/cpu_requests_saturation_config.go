...
type CpuRequestsSaturationConfig struct {
	...
	SamplePeriodInMinutes      int `json:"samplePeriodInMinutes"`      // of cluster CPU capacity for at least
	Threshold                  int `json:"threshold"`                  // amount of requested CPU is above
}
