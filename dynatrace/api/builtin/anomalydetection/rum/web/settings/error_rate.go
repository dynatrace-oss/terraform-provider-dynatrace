...
func (me *ErrorRate) HandlePreconditions() error {
	if (me.ErrorRateAuto != nil) && (!me.Enabled || (me.ErrorRateDetectionMode == nil || string(*me.ErrorRateDetectionMode) != "auto")) {
		return fmt.Errorf("'error_rate_auto' must not be specified unless ('enabled' is set to 'true' and 'error_rate_detection_mode' is set to 'auto'); got 'enabled'='%v', 'error_rate_detection_mode'='%v'", me.Enabled, me.ErrorRateDetectionMode)
	}
	if (me.ErrorRateAuto == nil) && (me.Enabled && (me.ErrorRateDetectionMode != nil && string(*me.ErrorRateDetectionMode) == "auto")) {
		return fmt.Errorf("'error_rate_auto' must be specified when ('enabled' is set to 'true' and 'error_rate_detection_mode' is set to 'auto'); got 'enabled'='%v', 'error_rate_detection_mode'='%v'", me.Enabled, me.ErrorRateDetectionMode)
	}
	...
	if (me.ErrorRateFixed != nil) && (!me.Enabled || (me.ErrorRateDetectionMode == nil || string(*me.ErrorRateDetectionMode) != "fixed")) {
		return fmt.Errorf("'error_rate_fixed' must not be specified unless ('enabled' is set to 'true' and 'error_rate_detection_mode' is set to 'fixed'); got 'enabled'='%v', 'error_rate_detection_mode'='%v'", me.Enabled, me.ErrorRateDetectionMode)
	}
	if (me.ErrorRateFixed == nil) && (me.Enabled && (me.ErrorRateDetectionMode != nil && string(*me.ErrorRateDetectionMode) == "fixed")) {
		return fmt.Errorf("'error_rate_fixed' must be specified when ('enabled' is set to 'true' and 'error_rate_detection_mode' is set to 'fixed'); got 'enabled'='%v', 'error_rate_detection_mode'='%v'", me.Enabled, me.ErrorRateDetectionMode)
	}
	return nil
}
