...
func (me *ResponseTime) HandlePreconditions() error {
	...
	if (me.ResponseTimeAuto != nil) && (!me.Enabled || (me.DetectionMode == nil || string(*me.DetectionMode) != "auto")) {
		return fmt.Errorf("'response_time_auto' must not be specified unless ('enabled' is set to 'true' and 'detection_mode' is set to 'auto'); got 'enabled'='%v', 'detection_mode'='%v'", me.Enabled, opt.ValOrNil(me.DetectionMode))
	}
	if (me.ResponseTimeAuto == nil) && (me.Enabled && (me.DetectionMode != nil && string(*me.DetectionMode) == "auto")) {
		return fmt.Errorf("'response_time_auto' must be specified when ('enabled' is set to 'true' and 'detection_mode' is set to 'auto'); got 'enabled'='%v', 'detection_mode'='%v'", me.Enabled, opt.ValOrNil(me.DetectionMode))
	}
	if (me.ResponseTimeFixed != nil) && (!me.Enabled || (me.DetectionMode == nil || string(*me.DetectionMode) != "fixed")) {
		return fmt.Errorf("'response_time_fixed' must not be specified unless ('enabled' is set to 'true' and 'detection_mode' is set to 'fixed'); got 'enabled'='%v', 'detection_mode'='%v'", me.Enabled, opt.ValOrNil(me.DetectionMode))
	}
	if (me.ResponseTimeFixed == nil) && (me.Enabled && (me.DetectionMode != nil && string(*me.DetectionMode) == "fixed")) {
		return fmt.Errorf("'response_time_fixed' must be specified when ('enabled' is set to 'true' and 'detection_mode' is set to 'fixed'); got 'enabled'='%v', 'detection_mode'='%v'", me.Enabled, opt.ValOrNil(me.DetectionMode))
	}
	return nil
}
