...
func Service(clientSet rest.ClientSet) (settings.CRUDService[*custom.Settings], error) {
	return settings20.Service[*custom.Settings](clientSet, SchemaID, SchemaVersion)
}
