resource "dynatrace_business_events_oneagent" "first-instance" {
  enabled   = true
  rule_name = "#name#"
  scope     = "environment"
  event {
...
resource "dynatrace_business_events_oneagent" "second-instance" {
  enabled   = true
  ...
  insert_after = dynatrace_business_events_oneagent.first-instance.id
}
