...
type Settings struct {
	...
	DefaultLogLevel   DefaultLogLevel         `json:"defaultLogLevel"`         // Default log level. Possible values: `debug`, `error`, `info`, `off`, `warn`
	DefaultTraceLevel DefaultServerlessTraces `json:"defaultTraceLevel"`       // App function traces. Possible values: `off`, `on`
}
...
func (me *Settings) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"default_log_level": {
			...
			Description: "Default log level. Possible values: `debug`, `error`, `info`, `off`, `warn`",
			Required:    true,
		},
		"default_trace_level": {
			Type:        schema.TypeString,
			Description: "App function traces. Possible values: `off`, `on`",
			Required:    true,
		},
	}
}
