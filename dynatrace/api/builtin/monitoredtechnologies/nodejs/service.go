...
func Service(clientSet rest.ClientSet) (settings.CRUDService[*nodejs.Settings], error) {
	return settings20.Service[*nodejs.Settings](clientSet, SchemaID, SchemaVersion)
}
