...
package attackprotectionallowlistconfig_test
...
func TestAppSecAttackProtectionAllowlist(t *testing.T) {
	api.TestService(t, attackprotectionallowlistconfig.Service)
}
