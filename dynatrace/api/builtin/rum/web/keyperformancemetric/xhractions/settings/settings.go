...
type Settings struct {
	...
	Kpm                XhrKpm              `json:"kpm"`                          // (Field has overlap with `dynatrace_web_application`) Key performance metric. Possible values: `RESPONSE_END`, `RESPONSE_START`, `USER_ACTION_DURATION`, `VISUALLY_COMPLETE`
