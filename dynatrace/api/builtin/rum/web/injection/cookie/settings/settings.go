...
type Settings struct {
	...
	SameSiteCookieAttribute  SameSiteCookieAttribute `json:"sameSiteCookieAttribute"`         // Define if your cookie should be restricted to a first-party or same-site context. Learn more about [SameSite cookies and available values](https://dt-url.net/yds1p8u). Possible values: `LAX`, `NONE`, `NOTSET`, `STRICT`
