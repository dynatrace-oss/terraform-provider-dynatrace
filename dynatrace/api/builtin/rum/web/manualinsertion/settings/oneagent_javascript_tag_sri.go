...
func (me *OneagentJavascriptTagSRI) IsEmpty() bool {
	return me == nil || me.ScriptExecutionAttribute == nil
}

type OneagentJavascriptTagSRI struct {
...
func (me *OneagentJavascriptTagSRI) Schema() map[string]*schema.Schema {
...
func (me *OneagentJavascriptTagSRI) MarshalHCL(properties hcl.Properties) error {
	return properties.EncodeAll(map[string]any{
		"script_execution_attribute": me.ScriptExecutionAttribute,
	})
}

func (me *OneagentJavascriptTagSRI) UnmarshalHCL(decoder hcl.Decoder) error {
