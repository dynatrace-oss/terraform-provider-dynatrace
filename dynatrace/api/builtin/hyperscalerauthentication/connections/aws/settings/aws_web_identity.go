...
type AwsWebIdentity struct {
	Consumers []ConsumersOfAwsWebIdentity `json:"consumers,omitempty"` // Dynatrace integrations that can use this connection. Possible values: `APP:dynatrace.aws.connector`
