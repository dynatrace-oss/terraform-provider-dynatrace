...
type AwsRoleBasedAuthenticationConfig struct {
	Consumers []ConsumersOfAwsRoleBasedAuthentication `json:"consumers,omitempty"` // Dynatrace integrations that can use this connection. Possible values: `DA`, `NONE`, `SVC:com.dynatrace.bo`, `SVC:com.dynatrace.da`, `SVC:com.dynatrace.grail`, `SVC:com.dynatrace.openpipeline`
