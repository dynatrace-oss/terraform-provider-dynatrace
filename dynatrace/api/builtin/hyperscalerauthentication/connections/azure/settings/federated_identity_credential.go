...
type FederatedIdentityCredential struct {
	...
	Consumers     []ConsumersOfFederatedIdentityCredential `json:"consumers,omitempty"`     // Consumers that can use the connection. Possible values: `APP:dynatrace.microsoft.azure.connector`, `DA`, `NONE`, `SVC:com.dynatrace.da`, `SVC:com.dynatrace.grail`, `SVC:com.dynatrace.openpipeline`
...
func (me *FederatedIdentityCredential) Schema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		"consumers": {
			...
			Description: "Consumers that can use the connection. Possible values: `APP:dynatrace.microsoft.azure.connector`, `DA`, `NONE`, `SVC:com.dynatrace.da`, `SVC:com.dynatrace.grail`, `SVC:com.dynatrace.openpipeline`",
