...
func Service(credentials *config.ProviderConfiguration) settings.CRUDService[*logagentconfiguration.Settings] {
	return settings20.Service[*logagentconfiguration.Settings](credentials, SchemaID, SchemaVersion)
}
