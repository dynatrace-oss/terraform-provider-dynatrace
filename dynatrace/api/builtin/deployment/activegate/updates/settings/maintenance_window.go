...
type MaintenanceWindow struct {
	MaintenanceWindow string `json:"maintenanceWindow"` // Select an [update window for ActiveGate updates](/ui/settings/builtin:deployment.management.update-windows)
}
