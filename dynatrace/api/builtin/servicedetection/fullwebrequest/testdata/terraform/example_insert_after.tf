...
resource "dynatrace_service_full_web_request" "first-instance" {
  name             = "#name#"
...
resource "dynatrace_service_full_web_request" "second-instance" {
  name             = "#name#"
  description      = "Created by Terraform"
  enabled          = false
  management_zones = [ dynatrace_management_zone_v2.my-mgmz.id ]
  ...
  insert_after = dynatrace_service_full_web_request.first-instance.id
}
