...
func (me *service) Create(ctx context.Context, v *users.UserConfig, m any) (*api.Stub, error) {
	return me.serviceClient.Create(ctx, v)
}

func (me *service) Update(ctx context.Context, id string, v *users.UserConfig, m any) error {
...
func (me *service) Get(ctx context.Context, id string, v *users.UserConfig, m any) error {
