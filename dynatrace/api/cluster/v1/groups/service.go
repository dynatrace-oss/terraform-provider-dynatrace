...
func (me *service) Create(ctx context.Context, v *groups.GroupConfig, m any) (*api.Stub, error) {
	return me.serviceClient.Create(ctx, v)
}

func (me *service) Update(ctx context.Context, id string, v *groups.GroupConfig, m any) error {
...
func (me *service) Get(ctx context.Context, id string, v *groups.GroupConfig, m any) error {
