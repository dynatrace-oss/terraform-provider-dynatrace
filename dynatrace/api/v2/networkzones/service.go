...
func (me *service) Get(ctx context.Context, id string, v *networkzones.NetworkZone) error {
	return me.client.Get(ctx, fmt.Sprintf("/api/v2/networkZones/%s", url.PathEscape(id))).Finish(v)
}
...
func (me *service) List(ctx context.Context) (api.Stubs, error) {
	...
	if err = me.client.Get(ctx, "/api/v2/networkZones").Finish(&stubList); err != nil {
		return nil, err
	}
	stubs := api.Stubs{}
...
func (me *service) Create(ctx context.Context, v *networkzones.NetworkZone) (*api.Stub, error) {
	...
	req := me.client.Put(ctx, fmt.Sprintf("/api/v2/networkZones/%s", url.PathEscape(id)), v)
...
func (me *service) Update(ctx context.Context, id string, v *networkzones.NetworkZone) error {
	...
	if err := me.client.Put(ctx, fmt.Sprintf("/api/v2/networkZones/%s", url.PathEscape(id)), v).Finish(); err != nil {
		return err
	}
	return nil
}
...
func (me *service) Delete(ctx context.Context, id string) error {
	return me.client.Delete(ctx, fmt.Sprintf("/api/v2/networkZones/%s", url.PathEscape(id))).Finish()
}
