...
func (g *Users) Schema() map[string]*schema.Schema {
...
func (g *Users) MarshalHCL(properties hcl.Properties) error {
	return properties.EncodeSlice("user", g)
}

func (g *Users) UnmarshalHCL(decoder hcl.Decoder) error {
	return decoder.DecodeSlice("user", g)
}
