...
func Service(entityType string, entityName string, entitySelector string, from string, to string, clientSet rest.ClientSet) settings.RService[*entities.Settings] {
	return &service{entityType: entityType, entityName: entityName, entitySelector: entitySelector, from: from, to: to, client: rest.APITokenClient(clientSet.Credentials())}
}
