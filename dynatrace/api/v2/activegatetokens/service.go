...
func (me *service) Get(id string, v *activegatetokens.Settings) error {
	var err error
...
func (me *service) Create(v *activegatetokens.Settings) (*api.Stub, error) {
	var err error
...
func (me *service) Update(id string, v *activegatetokens.Settings) error {
	return nil
}
