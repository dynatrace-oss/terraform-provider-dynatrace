...
type Settings struct {
	BooleanValue *bool        `json:"booleanValue,omitempty"` // State of boolean feature
	Name         string       `json:"name"`                   // Name of the feature
	NumberValue  *int         `json:"numberValue,omitempty"`  // State of numeric feature
	StringValue  *string      `json:"stringValue,omitempty"`  // State of textual feature
