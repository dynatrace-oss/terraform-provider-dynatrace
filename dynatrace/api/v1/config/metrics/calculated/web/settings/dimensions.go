...
type Dimension struct {
	...
	Dimension   MetricDimension `json:"dimension"`             // The dimension of the metric. Possible values are `ApdexType`, `Browser`, `ErrorContext`, `ErrorOrigin`, `ErrorType`, `GeoLocation`, `StringProperty`, `UserActionType`
	PropertyKey *string         `json:"propertyKey,omitempty"` // The key of the user action property. Only applicable for the StringProperty dimension.
}
...
var MetricDimensions = struct {
	ApdexType      MetricDimension
	Browser        MetricDimension
	ErrorContext   MetricDimension
	ErrorOrigin    MetricDimension
	ErrorType      MetricDimension
	GeoLocation    MetricDimension
	StringProperty MetricDimension
	UserActionType MetricDimension
}{
	"ApdexType",
	"Browser",
	"ErrorContext",
