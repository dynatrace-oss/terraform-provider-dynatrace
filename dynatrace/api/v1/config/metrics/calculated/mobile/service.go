...
func (me *service) Get(ctx context.Context, id string, v *mysettings.CalculatedMobileMetric, m any) error {
...
func (me *service) Validate(ctx context.Context, v *mysettings.CalculatedMobileMetric) error {
	var err error
	client := me.client
...
func (me *service) Create(ctx context.Context, v *mysettings.CalculatedMobileMetric, m any) (*api.Stub, error) {
	var err error
	client := me.client
	var stub api.Stub
...
func (me *service) Update(ctx context.Context, id string, v *mysettings.CalculatedMobileMetric, m any) error {
