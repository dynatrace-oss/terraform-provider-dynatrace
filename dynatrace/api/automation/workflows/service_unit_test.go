...
func mockClientGetter(client *mockAutomationClient) func(ctx context.Context, credentials *config.ProviderConfiguration) (workflows.AutomationClient, error) {
	return func(ctx context.Context, credentials *config.ProviderConfiguration) (workflows.AutomationClient, error) {
		return client, nil
	}
}

func failingClientGetter(err error) func(ctx context.Context, credentials *config.ProviderConfiguration) (workflows.AutomationClient, error) {
	return func(ctx context.Context, credentials *config.ProviderConfiguration) (workflows.AutomationClient, error) {
		return nil, err
	}
}
