...
func (c *PlatformCredentials) ContainsWorkloadIdentityFederation() bool {
	return len(c.WorkloadIdentityFederationAudience) > 0
}
...
func (c *Credentials) ContainsPlatformCredentials() bool {
	return c.Platform.ContainsWorkloadIdentityFederation() || c.ContainsOAuth() || c.ContainsPlatformToken()
}
