...
package requestattributes_test
...
import (
	...
	dbs "github.com/dtcookie/dynatrace/api/config/requestattributes"
...
const ResourceName = "dynatrace_request_attribute"
const TestDataFolder = "../test_data/request_attributes"
const RequestPath = "%s/requestAtributes/%s"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := dbs.NewService(providerConf.DTenvURL, providerConf.APIToken)
