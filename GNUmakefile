...
testacc: fmtcheck
	mkdir -p ~/.terraform.d/plugins/dynatrace.com/com/dynatrace/0.1.0/$(OS_ARCH)
	go clean -cache
	go build -o ~/.terraform.d/plugins/dynatrace.com/com/dynatrace/0.1.0/$(OS_ARCH)/terraform-provider-dynatrace_0.1.0_$(OS_ARCH)
