---
layout: ""
page_title: "dynatrace_openpipeline_v2_metrics_dataforwarding Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_metrics_dataforwarding` covers configuration of OpenPipeline for metrics data forwarding
---

# dynatrace_openpipeline_v2_metrics_dataforwarding (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_metrics_dataforwarding` downloads all existing OpenPipeline definitions for metrics data forwarding
...
```terraform
resource "dynatrace_openpipeline_v2_metrics_dataforwarding" "example" {
  ...
  pipelines            = [dynatrace_openpipeline_v2_metrics_pipelines.pipeline.id]
