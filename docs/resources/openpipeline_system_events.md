---
layout: ""
page_title: "dynatrace_openpipeline_system_events Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline"
description: |-
  The resource `dynatrace_openpipeline_system_events` covers configuration of OpenPipeline for system events
---

# dynatrace_openpipeline_system_events (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_system_events` downloads all existing OpenPipeline definitions for sytem events
