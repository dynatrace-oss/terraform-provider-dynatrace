---
layout: ""
page_title: "dynatrace_openpipeline_sdlc_events Resource - terraform-provider-dynatrace"
subcategory: "Deprecated"
description: |-
  The resource `dynatrace_openpipeline_sdlc_events` covers configuration of OpenPipeline for Software Development Lifecycle Events
---

# dynatrace_openpipeline_sdlc_events (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_sdlc_events` downloads all existing OpenPipeline definitions for Software Development Lifecycle Events
