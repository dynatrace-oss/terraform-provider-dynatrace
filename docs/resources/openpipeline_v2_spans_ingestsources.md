---
layout: ""
page_title: "dynatrace_openpipeline_v2_spans_ingestsources Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_spans_ingestsources` covers configuration of OpenPipeline for spans ingest sources
---

# dynatrace_openpipeline_v2_spans_ingestsources (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_spans_ingestsources` downloads all existing OpenPipeline definitions for spans ingest sources
