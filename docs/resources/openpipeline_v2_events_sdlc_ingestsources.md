---
layout: ""
page_title: "dynatrace_openpipeline_v2_events_sdlc_ingestsources Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_events_sdlc_ingestsources` covers configuration of OpenPipeline for events sdlc ingest sources
---

# dynatrace_openpipeline_v2_events_sdlc_ingestsources (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_events_sdlc_ingestsources` downloads all existing OpenPipeline definitions for events sdlc ingest sources
