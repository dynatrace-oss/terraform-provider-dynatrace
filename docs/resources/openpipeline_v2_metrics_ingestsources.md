---
layout: ""
page_title: "dynatrace_openpipeline_v2_metrics_ingestsources Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_metrics_ingestsources` covers configuration of OpenPipeline for metrics ingest sources
---

# dynatrace_openpipeline_v2_metrics_ingestsources (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_metrics_ingestsources` downloads all existing OpenPipeline definitions for metrics ingest sources
