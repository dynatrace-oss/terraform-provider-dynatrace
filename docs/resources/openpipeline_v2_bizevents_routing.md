---
layout: ""
page_title: "dynatrace_openpipeline_v2_bizevents_routing Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_bizevents_routing` covers configuration of OpenPipeline for bizevents routing
---

# dynatrace_openpipeline_v2_bizevents_routing (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_bizevents_routing` downloads all existing OpenPipeline definitions for bizevents routing
