...
- `type` (String) Rule type. Possible values: `DIMENSION`, `ME`, `SELECTOR`
...
- `applies_to` (String) Type. Possible values: `ANY`, `LOG`, `METRIC`
...
- `condition_type` (String) Type. Possible values: `DIMENSION`, `LOG_FILE_NAME`, `METRIC_KEY`
- `rule_matcher` (String) Operator. Possible values: `BEGINS_WITH`, `EQUALS`
