---
layout: ""
page_title: "dynatrace_openpipeline_v2_events_sdlc_dataforwarding Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_events_sdlc_dataforwarding` covers configuration of OpenPipeline for events sdlc data forwarding
---

# dynatrace_openpipeline_v2_events_sdlc_dataforwarding (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_events_sdlc_dataforwarding` downloads all existing OpenPipeline definitions for events sdlc data forwarding
...
resource "dynatrace_openpipeline_v2_events_sdlc_dataforwarding" "example" {
  ...
  pipelines            = [dynatrace_openpipeline_v2_events_sdlc_pipelines.pipeline.id]
