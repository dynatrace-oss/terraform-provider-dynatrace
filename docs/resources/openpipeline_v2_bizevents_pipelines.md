---
layout: ""
page_title: "dynatrace_openpipeline_v2_bizevents_pipelines Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_bizevents_pipelines` covers configuration of OpenPipeline for bizevents pipelines
---

# dynatrace_openpipeline_v2_bizevents_pipelines (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_bizevents_pipelines` downloads all existing OpenPipeline definitions for bizevents pipelines
