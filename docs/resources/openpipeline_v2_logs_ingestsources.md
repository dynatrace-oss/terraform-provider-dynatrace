---
layout: ""
page_title: "dynatrace_openpipeline_v2_logs_ingestsources Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_logs_ingestsources` covers configuration of OpenPipeline for logs ingest sources
---

# dynatrace_openpipeline_v2_logs_ingestsources (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_logs_ingestsources` downloads all existing OpenPipeline definitions for logs ingest sources
