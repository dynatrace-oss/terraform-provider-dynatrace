---
layout: ""
page_title: "dynatrace_openpipeline_v2_user_events_dataforwarding Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_user_events_dataforwarding` covers configuration of OpenPipeline for user events data forwarding
---

# dynatrace_openpipeline_v2_user_events_dataforwarding (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_user_events_dataforwarding` downloads all existing OpenPipeline definitions for user events data forwarding
