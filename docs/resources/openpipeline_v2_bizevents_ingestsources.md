---
layout: ""
page_title: "dynatrace_openpipeline_v2_bizevents_ingestsources Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_bizevents_ingestsources` covers configuration of OpenPipeline for bizevents ingest sources
---

# dynatrace_openpipeline_v2_bizevents_ingestsources (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_bizevents_ingestsources` downloads all existing OpenPipeline definitions for bizevents ingest sources
