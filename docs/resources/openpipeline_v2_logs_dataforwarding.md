---
layout: ""
page_title: "dynatrace_openpipeline_v2_logs_dataforwarding Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_logs_dataforwarding` covers configuration of OpenPipeline for logs data forwarding
---

# dynatrace_openpipeline_v2_logs_dataforwarding (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_logs_dataforwarding` downloads all existing OpenPipeline definitions for logs data forwarding
...
```terraform
resource "dynatrace_openpipeline_v2_logs_dataforwarding" "example" {
  ...
  pipelines            = [dynatrace_openpipeline_v2_logs_pipelines.pipeline.id]
