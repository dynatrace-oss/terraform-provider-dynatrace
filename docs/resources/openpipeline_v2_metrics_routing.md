---
layout: ""
page_title: "dynatrace_openpipeline_v2_metrics_routing Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_metrics_routing` covers configuration of OpenPipeline for metrics routing
---

# dynatrace_openpipeline_v2_metrics_routing (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_metrics_routing` downloads all existing OpenPipeline definitions for metrics routing
