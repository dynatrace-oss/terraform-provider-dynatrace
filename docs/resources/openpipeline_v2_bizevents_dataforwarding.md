---
layout: ""
page_title: "dynatrace_openpipeline_v2_bizevents_dataforwarding Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_bizevents_dataforwarding` covers configuration of OpenPipeline for bizevents data forwarding
---

# dynatrace_openpipeline_v2_bizevents_dataforwarding (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_bizevents_dataforwarding` downloads all existing OpenPipeline definitions for bizevents data forwarding
...
```terraform
resource "dynatrace_openpipeline_v2_bizevents_dataforwarding" "example" {
  ...
  pipelines            = [dynatrace_openpipeline_v2_bizevents_pipelines.pipeline.id]
