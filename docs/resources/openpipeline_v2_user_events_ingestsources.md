---
layout: ""
page_title: "dynatrace_openpipeline_v2_user_events_ingestsources Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_user_events_ingestsources` covers configuration of OpenPipeline for user events ingest sources
---

# dynatrace_openpipeline_v2_user_events_ingestsources (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_user_events_ingestsources` downloads all existing OpenPipeline definitions for user events ingest sources
