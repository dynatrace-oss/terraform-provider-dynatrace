---
layout: ""
page_title: "dynatrace_openpipeline_v2_system_events_pipelines Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_system_events_pipelines` covers configuration of OpenPipeline for system events pipelines
---

# dynatrace_openpipeline_v2_system_events_pipelines (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_system_events_pipelines` downloads all existing OpenPipeline definitions for system events pipelines
