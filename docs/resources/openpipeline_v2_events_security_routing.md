---
layout: ""
page_title: "dynatrace_openpipeline_v2_events_security_routing Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_events_security_routing` covers configuration of OpenPipeline for events security routing
---

# dynatrace_openpipeline_v2_events_security_routing (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_events_security_routing` downloads all existing OpenPipeline definitions for events security routing
