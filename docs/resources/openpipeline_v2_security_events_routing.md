---
layout: ""
page_title: "dynatrace_openpipeline_v2_security_events_routing Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_security_events_routing` covers configuration of OpenPipeline for security events routing
---

# dynatrace_openpipeline_v2_security_events_routing (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_security_events_routing` downloads all existing OpenPipeline definitions for security events routing
