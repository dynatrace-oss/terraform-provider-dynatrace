---
layout: ""
page_title: "dynatrace_openpipeline_v2_davis_problems_dataforwarding Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_davis_problems_dataforwarding` covers configuration of OpenPipeline for davis problems data forwarding
---

# dynatrace_openpipeline_v2_davis_problems_dataforwarding (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_davis_problems_dataforwarding` downloads all existing OpenPipeline definitions for davis problems data forwarding
...
```terraform
resource "dynatrace_openpipeline_v2_davis_problems_dataforwarding" "example" {
  ...
  pipelines            = [dynatrace_openpipeline_v2_davis_problems_pipelines.pipeline.id]
