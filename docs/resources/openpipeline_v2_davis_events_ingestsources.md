---
layout: ""
page_title: "dynatrace_openpipeline_v2_davis_events_ingestsources Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_davis_events_ingestsources` covers configuration of OpenPipeline for davis events ingest sources
---

# dynatrace_openpipeline_v2_davis_events_ingestsources (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_davis_events_ingestsources` downloads all existing OpenPipeline definitions for davis events ingest sources
