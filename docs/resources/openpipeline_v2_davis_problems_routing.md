---
layout: ""
page_title: "dynatrace_openpipeline_v2_davis_problems_routing Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_davis_problems_routing` covers configuration of OpenPipeline for davis problems routing
---

# dynatrace_openpipeline_v2_davis_problems_routing (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_davis_problems_routing` downloads all existing OpenPipeline definitions for davis problems routing
