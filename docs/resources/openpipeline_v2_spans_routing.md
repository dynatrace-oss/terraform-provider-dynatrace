---
layout: ""
page_title: "dynatrace_openpipeline_v2_spans_routing Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_spans_routing` covers configuration of OpenPipeline for spans routing
---

# dynatrace_openpipeline_v2_spans_routing (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_spans_routing` downloads all existing OpenPipeline definitions for spans routing
