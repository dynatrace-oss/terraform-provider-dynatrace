---
layout: ""
page_title: "dynatrace_openpipeline_v2_spans_dataforwarding Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_spans_dataforwarding` covers configuration of OpenPipeline for spans data forwarding
---

# dynatrace_openpipeline_v2_spans_dataforwarding (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_spans_dataforwarding` downloads all existing OpenPipeline definitions for spans data forwarding
...
```terraform
resource "dynatrace_openpipeline_v2_spans_dataforwarding" "example" {
  ...
  pipelines            = [dynatrace_openpipeline_v2_spans_pipelines.pipeline.id]
