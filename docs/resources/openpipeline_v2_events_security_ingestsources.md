---
layout: ""
page_title: "dynatrace_openpipeline_v2_events_security_ingestsources Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline V2"
description: |-
  The resource `dynatrace_openpipeline_v2_events_security_ingestsources` covers configuration of OpenPipeline for events security ingest sources
---

# dynatrace_openpipeline_v2_events_security_ingestsources (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_v2_events_security_ingestsources` downloads all existing OpenPipeline definitions for events security ingest sources
