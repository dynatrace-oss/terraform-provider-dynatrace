---
layout: ""
page_title: "dynatrace_openpipeline_spans Resource - terraform-provider-dynatrace"
subcategory: "OpenPipeline"
description: |-
  The resource `dynatrace_openpipeline_spans` covers configuration of OpenPipeline for Spans
---

# dynatrace_openpipeline_spans (Resource)
...
- `terraform-provider-dynatrace -export dynatrace_openpipeline_spans` downloads all existing OpenPipeline definitions for Spans
