...
require (
	...
	github.com/dtcookie/dynatrace/api/config/anomalies/hosts v1.0.4
	github.com/dtcookie/dynatrace/api/config/anomalies/metricevents v1.0.5
	github.com/dtcookie/dynatrace/api/config/anomalies/services v1.0.9
	github.com/dtcookie/dynatrace/api/config/autotags v1.0.18
	github.com/dtcookie/dynatrace/api/config/credentials/aws v1.0.8
	github.com/dtcookie/dynatrace/api/config/credentials/azure v1.0.7
	github.com/dtcookie/dynatrace/api/config/credentials/kubernetes v1.0.10
	github.com/dtcookie/dynatrace/api/config/customservices v1.0.13
	github.com/dtcookie/dynatrace/api/config/dashboards v1.0.11
	...
	github.com/dtcookie/dynatrace/api/config/notifications v1.0.10
	github.com/dtcookie/dynatrace/api/config/requestattributes v1.0.7
