...
require (
	...
	github.com/dtcookie/dynatrace/api/config/customservices v1.0.19
	...
	github.com/dtcookie/dynatrace/api/config/requestattributes v1.0.12
	...
	github.com/dtcookie/dynatrace/api/config/v2/keyrequests v1.0.3
	github.com/dtcookie/dynatrace/api/config/v2/maintenance v1.0.1
	github.com/dtcookie/dynatrace/api/config/v2/networkzones v1.0.4
	github.com/dtcookie/dynatrace/api/config/v2/notifications v1.0.6
	github.com/dtcookie/dynatrace/api/config/v2/slo v1.0.7
	github.com/dtcookie/dynatrace/api/config/v2/spans/attributes v1.0.2
	github.com/dtcookie/dynatrace/api/config/v2/spans/capture v1.0.2
