...
require (
	...
	github.com/dtcookie/dynatrace/api/accounts/iam v1.0.3
	...
	github.com/dtcookie/dynatrace/api/config/anomalies/processgroups v1.0.1
	...
	github.com/dtcookie/dynatrace/api/config/dashboards v1.0.24
