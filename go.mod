...
require (
	...
	github.com/dtcookie/dynatrace/api/config/applications/web v1.0.12
	github.com/dtcookie/dynatrace/api/config/applications/web/applicationdetectionrules v1.0.1
	github.com/dtcookie/dynatrace/api/config/autotags v1.0.25
	...
	github.com/dtcookie/dynatrace/api/config/dashboards v1.0.18
	...
	github.com/dtcookie/dynatrace/api/config/v2/maintenance v1.0.0
	github.com/dtcookie/dynatrace/api/config/v2/networkzones v1.0.1
	github.com/dtcookie/dynatrace/api/config/v2/notifications v1.0.4
