...
require (
	...
	github.com/dtcookie/dynatrace/api/config/anomalies/metricevents v1.0.16
	github.com/dtcookie/dynatrace/api/config/anomalies/services v1.0.13
	github.com/dtcookie/dynatrace/api/config/applications/mobile v1.0.5
	github.com/dtcookie/dynatrace/api/config/applications/web v1.0.16
	...
	github.com/dtcookie/dynatrace/api/config/credentials/azure v1.0.13
	...
	github.com/dtcookie/dynatrace/api/config/dashboards v1.0.22
	...
	github.com/dtcookie/dynatrace/api/config/metrics/calculated/service v1.0.9
	...
	github.com/dtcookie/dynatrace/api/config/synthetic/monitors v1.0.19
	...
	github.com/dtcookie/dynatrace/api/config/topology/service v1.0.3
	github.com/dtcookie/dynatrace/api/config/topology/tag v1.0.0
	github.com/dtcookie/dynatrace/api/config/v2/alerting v1.0.6
	github.com/dtcookie/dynatrace/api/config/v2/anomalies/frequentissues v1.0.1
	github.com/dtcookie/dynatrace/api/config/v2/anomalies/metricevents v1.0.0
	github.com/dtcookie/dynatrace/api/config/v2/ibmmq/filters v1.0.2
	...
	github.com/dtcookie/dynatrace/api/config/v2/spans/attributes v1.0.4
