...
require (
	...
	github.com/dtcookie/dynatrace/api/config/alerting v1.0.2
	github.com/dtcookie/dynatrace/api/config/autotags v1.0.6
	...
	github.com/dtcookie/dynatrace/api/config/customservices v1.0.7
	...
	github.com/dtcookie/dynatrace/api/config/managementzones v1.0.6
