...
import (
	...
	maintenanceapi "github.com/dtcookie/dynatrace/api/config/v2/maintenance"
...
const ResourceName = "dynatrace_management_zone_v2"
const TestDataFolder = "../../test_data/management_zone"
...
func TestManagementZoneV2(t *testing.T) {
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := maintenanceapi.NewService(providerConf.DTApiV2URL, providerConf.APIToken)
