...
import (
	...
	"github.com/dtcookie/dynatrace/api/config/naming/processgroups"
...
const ResourceName = "dynatrace_processgroup_naming"
const TestDataFolder = "../../../test_data/naming/processgroups"
const RequestPath = "%s/conditionalNaming/processGroup/%s"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := processgroups.NewService(providerConf.DTenvURL, providerConf.APIToken)
