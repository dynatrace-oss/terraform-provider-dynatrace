...
import (
	...
	"github.com/dtcookie/dynatrace/api/config/naming/hosts"
...
const ResourceName = "dynatrace_host_naming"
const TestDataFolder = "../../../test_data/naming/hosts"
const RequestPath = "%s/conditionalNaming/host/%s"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := hosts.NewService(providerConf.DTenvURL, providerConf.APIToken)
