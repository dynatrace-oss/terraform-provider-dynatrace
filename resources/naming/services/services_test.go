...
import (
	...
	"github.com/dtcookie/dynatrace/api/config/naming/services"
...
const ResourceName = "dynatrace_service_naming"
const TestDataFolder = "../../../test_data/naming/services"
const RequestPath = "%s/conditionalNaming/service/%s"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := services.NewService(providerConf.DTenvURL, providerConf.APIToken)
