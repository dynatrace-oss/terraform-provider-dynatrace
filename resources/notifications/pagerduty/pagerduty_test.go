...
const ResourceName = "dynatrace_pager_duty_notification"
const TestDataFolder = "../../../test_data/notifications/pagerduty"
...
func (test *TestStruct) Anonymize(m map[string]interface{}) {
	...
	pagerDutyNotification := value["pagerDutyNotification"].(map[string]interface{})
	delete(pagerDutyNotification, "serviceApiKey")
