...
const ResourceName = "dynatrace_ansible_tower_notification"
const TestDataFolder = "../../../test_data/notifications/ansible"
...
func (test *TestStruct) Anonymize(m map[string]interface{}) {
	...
	ansibleTowerNotification := value["ansibleTowerNotification"].(map[string]interface{})
	delete(ansibleTowerNotification, "password")
