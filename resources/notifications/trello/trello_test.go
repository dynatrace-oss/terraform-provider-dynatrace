...
const ResourceName = "dynatrace_trello_notification"
const TestDataFolder = "../../../test_data/notifications/trello"
...
func (test *TestStruct) Anonymize(m map[string]interface{}) {
	...
	trelloNotification := value["trelloNotification"].(map[string]interface{})
	delete(trelloNotification, "authorizationToken")
