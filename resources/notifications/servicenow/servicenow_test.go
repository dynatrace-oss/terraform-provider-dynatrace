...
const ResourceName = "dynatrace_service_now_notification"
const TestDataFolder = "../../../test_data/notifications/servicenow"
...
func (test *TestStruct) Anonymize(m map[string]interface{}) {
	...
	serviceNowNotification := value["serviceNowNotification"].(map[string]interface{})
	delete(serviceNowNotification, "password")
