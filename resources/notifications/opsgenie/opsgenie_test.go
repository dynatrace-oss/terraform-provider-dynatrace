...
const ResourceName = "dynatrace_ops_genie_notification"
const TestDataFolder = "../../../test_data/notifications/opsgenie"
...
func (test *TestStruct) Anonymize(m map[string]interface{}) {
	...
	opsGenieNotification := value["opsGenieNotification"].(map[string]interface{})
	delete(opsGenieNotification, "apiKey")
...
func TestOpsGenieNotifications(t *testing.T) {
