...
const ResourceName = "dynatrace_webhook_notification"
const TestDataFolder = "../../../test_data/notifications/webhook"
...
func (test *TestStruct) Anonymize(m map[string]interface{}) {
	...
	webHookNotification := value["webHookNotification"].(map[string]interface{})
	headers := webHookNotification["headers"].([]interface{})
