...
const ResourceName = "dynatrace_victor_ops_notification"
const TestDataFolder = "../../../test_data/notifications/victorops"
...
func (test *TestStruct) Anonymize(m map[string]interface{}) {
	...
	victorOpsNotification := value["victorOpsNotification"].(map[string]interface{})
	delete(victorOpsNotification, "apiKey")
