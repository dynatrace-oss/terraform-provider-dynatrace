...
const ResourceName = "dynatrace_xmatters_notification"
const TestDataFolder = "../../../test_data/notifications/xmatters"
...
func (test *TestStruct) Anonymize(m map[string]interface{}) {
	...
	xMattersNotification := value["xMattersNotification"].(map[string]interface{})
	headers := xMattersNotification["headers"].([]interface{})
	delete(headers[0].(map[string]interface{}), "secretValue")
	delete(headers[1].(map[string]interface{}), "secretValue")
