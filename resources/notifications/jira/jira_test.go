...
const ResourceName = "dynatrace_jira_notification"
const TestDataFolder = "../../../test_data/notifications/jira"
...
func (test *TestStruct) Anonymize(m map[string]interface{}) {
	...
	jiraNotification := value["jiraNotification"].(map[string]interface{})
	delete(jiraNotification, "apiToken")
...
func TestJiraNotifications(t *testing.T) {
