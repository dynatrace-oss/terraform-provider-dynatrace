...
import (
	...
	api "github.com/dtcookie/dynatrace/api/config/notifications"
...
const ResourceName = "dynatrace_notification"
const TestDataFolder = "../../test_data/notifications"
const RequestPath = "%s/notifications/%s"
const TestCaseID = "notifications"
