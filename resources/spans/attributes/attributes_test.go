...
import (
	...
	sloapi "github.com/dtcookie/dynatrace/api/config/v2/spans/attributes"
...
const ResourceName = "dynatrace_span_attribute"
const TestDataFolder = "../../../test_data/spans/attributes"
