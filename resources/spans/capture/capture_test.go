...
import (
	...
	sloapi "github.com/dtcookie/dynatrace/api/config/v2/spans/capture"
...
const ResourceName = "dynatrace_span_capture_rule"
const TestDataFolder = "../../../test_data/spans/capture"
...
func TestSpanCaptureA(t *testing.T) {
