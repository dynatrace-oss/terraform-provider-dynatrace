...
import (
	...
	sloapi "github.com/dtcookie/dynatrace/api/config/v2/spans/entrypoints"
...
const ResourceName = "dynatrace_span_entry_point"
const TestDataFolder = "../../../test_data/spans/entrypoints"
...
func TestSpanEntryPointsA(t *testing.T) {
...
func TestSpanEntryPointsB(t *testing.T) {
	test := &TestStruct{resourceKey: ResourceName}
	var err error
	var testCase *resource.TestCase
	if testCase, err = test.CreateTestCase(
