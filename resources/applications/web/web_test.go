...
const ResourceName = "dynatrace_web_application"
const TestDataFolder = "../../../test_data/applications/web"
const RequestPath = "%s/applications/web"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := web.NewService(providerConf.DTenvURL, providerConf.APIToken)
