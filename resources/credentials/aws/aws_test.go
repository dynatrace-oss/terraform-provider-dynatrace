...
const ResourceName = "dynatrace_aws_credentials"
const TestDataFolder = "../../../test_data/credentials/aws"
const RequestPath = "%s/aws/credentials/%s"
const TestCaseID = "aws_credentials"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := aws.NewService(providerConf.DTenvURL, providerConf.APIToken)
