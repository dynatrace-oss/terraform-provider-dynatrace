...
const ResourceName = "dynatrace_maintenance_window"
const TestDataFolder = "../../test_data/maintenance_windows"
const RequestPath = "%s/maintenanceWindows/%s"
const TestCaseID = "maintenance_windows"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := maintenance.NewService(providerConf.DTenvURL, providerConf.APIToken)
