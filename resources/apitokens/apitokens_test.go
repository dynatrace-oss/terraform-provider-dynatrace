...
const ResourceName = "dynatrace_api_token"
const TestDataFolder = "../../test_data/api_tokens"
const RequestPath = "%s/apiTokens/%s"
const TestCaseID = "api_tokens"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := apitokens.NewService(providerConf.DTApiV2URL, providerConf.APIToken)
