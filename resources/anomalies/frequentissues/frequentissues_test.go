...
const ResourceName = "dynatrace_frequent_issues"
const TestDataFolder = "../../../test_data/anomalies/frequent_issues"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := frequentissues.NewService(providerConf.DTApiV2URL, providerConf.APIToken)
