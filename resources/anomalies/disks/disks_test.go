...
const ResourceName = "dynatrace_disk_anomalies"
const TestDataFolder = "../../../test_data/anomalies/disk_events"
const RequestPath = "%s/anomalyDetection/diskEvents/%s"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := diskevents.NewService(providerConf.DTenvURL, providerConf.APIToken)
