...
const ResourceName = "dynatrace_metric_events"
const TestDataFolder = "../../../test_data/anomalies/metrics"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := metricevents.NewService(providerConf.DTApiV2URL, providerConf.APIToken)
