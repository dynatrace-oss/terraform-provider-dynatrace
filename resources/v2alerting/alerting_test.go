...
const ResourceName = "dynatrace_alerting"
const TestDataFolder = "../../test_data/alerting"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := alertingapi.NewService(providerConf.DTApiV2URL, providerConf.APIToken)
