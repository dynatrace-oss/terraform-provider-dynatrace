...
const ResourceName = "dynatrace_management_zone"
const TestDataFolder = "../../test_data/management_zones"
const RequestPath = "%s/managementZones/%s"
const TestCaseID = "management_zones"
