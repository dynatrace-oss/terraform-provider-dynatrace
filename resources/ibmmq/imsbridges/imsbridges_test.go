...
import (
	...
	imsapi "github.com/dtcookie/dynatrace/api/config/v2/ibmmq/imsbridges"
...
const ResourceName = "dynatrace_ims_bridges"
const TestDataFolder = "../../../test_data/ibmmq/imsbridges"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := imsapi.NewService(providerConf.DTApiV2URL, providerConf.APIToken)
