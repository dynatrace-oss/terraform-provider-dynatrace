...
import (
	...
	qmapi "github.com/dtcookie/dynatrace/api/config/v2/ibmmq/queuemanagers"
...
const ResourceName = "dynatrace_queue_manager"
const TestDataFolder = "../../../test_data/ibmmq/queuemanagers"
...
func TestQueueManagers(t *testing.T) {
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := qmapi.NewService(providerConf.DTApiV2URL, providerConf.APIToken)
