...
import (
	...
	qsgapi "github.com/dtcookie/dynatrace/api/config/v2/ibmmq/queuesharinggroups"
...
const ResourceName = "dynatrace_queue_sharing_groups"
const TestDataFolder = "../../../test_data/ibmmq/queuesharinggroups"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := qsgapi.NewService(providerConf.DTApiV2URL, providerConf.APIToken)
