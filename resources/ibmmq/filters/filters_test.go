...
import (
	...
	filtersapi "github.com/dtcookie/dynatrace/api/config/v2/ibmmq/filters"
...
const ResourceName = "dynatrace_ibm_mq_filters"
const TestDataFolder = "../../../test_data/ibmmq/filters"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := filtersapi.NewService(providerConf.DTApiV2URL, providerConf.APIToken)
