...
const ResourceName = "dynatrace_custom_anomalies"
const TestDataFolder = "../../test_data/anomalies/metric_events"
const RequestPath = "%s/anomalyDetection/metricEvents/%s"
...
func (test *TestStruct) CheckDestroy(s *terraform.State) error {
	...
	restClient := metricevents.NewService(providerConf.DTenvURL, providerConf.APIToken)
